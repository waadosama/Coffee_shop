...
class VerticalStripePainter extends CustomPainter {
  const VerticalStripePainter({
    this.stripe = AppColors.pastelPink,
    this.paper = AppColors.darkEspresso,
    this.stripeWidth = 18,
  });
  ...
  @override
  bool shouldRepaint(covariant VerticalStripePainter oldDelegate) =>
      oldDelegate.stripe != stripe || oldDelegate.stripeWidth != stripeWidth;
}
